...
const settingsSchema = new mongoose.Schema({
  ...
  welcomeSubtitle: { type: String, default: "Find your perfect study buddy and achieve your goals together." },
